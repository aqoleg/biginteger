// just having fun learning math and java
// integers of arbitrary length, represented as bit array
// api is similar to java.math.BigInteger, objects are immutable
...
public class BigInteger {
     ...
     * @return a positive BigInteger created from bytes
     * @throws NullPointerException           if bytes == null
     * @throws ArrayIndexOutOfBoundsException if bytesStart or bytesLength is incorrect
     */
     ...
     * @return a positive BigInteger created from bytes
     * @throws NullPointerException           if bytes == null
     * @throws ArrayIndexOutOfBoundsException if bytes length is incorrect
     */
     ...
     * @return a positive BigInteger created from bytes
     * @throws NullPointerException           if bytes == null
     * @throws ArrayIndexOutOfBoundsException if bytesStart or bytes length is incorrect
     */
    ...
    public int toInteger() {
        if (bitLength > 31) {
            throw new UnsupportedOperationException("contain " + bitLength + " bits, require < 32");
        }
        int n = 0;
        for (int i = 0; i < bitLength; i++) {
            if (bits[i]) {
    ...
    public byte[] toVariableLength() {
        ...
        if (absCompareTo(BigInteger.parse("0xFD")) == -1) {
            ...
            throw new UnsupportedOperationException("contain " + bitLength + " bits, require < 65");
        }
